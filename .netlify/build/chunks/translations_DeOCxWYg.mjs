import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, k as RenderUndefinedEntryError, l as escape$1, u as unescapeHTML, b as renderTemplate, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_Bg5UpsQb.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Bcu4jp4P.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://productiv-ai.netlify.app/", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_DPuO2cGS.mjs');
      const result = [];
    ...
    let entries = [];
    if (!Object.assign(__vite_import_meta_env__, { URL: process.env.URL, _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CINg-VyK.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_RTclfO9_.mjs');
...
const starlightConfig = {"social":[{"icon":"github","label":"Github","href":"https://github.com/Hisma/productiv-ai-site"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Start Learning","translations":{},"collapsed":false,"items":[{"label":"Deploy Linux & Docker/Portainer","translations":{},"slug":"start/wsl2-portainer","attrs":{}},{"label":"Install OpenWebUI and Ollama","translations":{},"slug":"start/ollama-open-webui","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"ProductivAI Docs"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///config/workspace/productiv-ai-site/","srcDir":"file:///config/workspace/productiv-ai-site/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, stripTrailingSlash as a, stripLeadingSlash as b, stripHtmlExtension as c, ensureTrailingSlash as d, ensureHtmlExtension as e, getCollectionPathFromRoot as f, getCollection as g, pickLang as h, stripLeadingAndTrailingSlashes as i, ensureLeadingSlash as j, stripExtension as k, arrayType as l, stringType as m, enumType as n, objectType as o, project as p, unionType as q, recordType as r, starlightConfig as s, booleanType as t, useTranslations as u, undefinedType as v, renderEntry as w, getEntry as x, getCollectionPath as y };
